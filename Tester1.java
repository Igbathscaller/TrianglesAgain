public class Tester1 {
    public static void main(String[] args) {
        ...
        System.out.println(new Point(0,0).distanceTo(new Point(4,0)));
        System.out.println(new Point(0,0).distanceTo(new Point(2,2*Math.sqrt(3))));
        System.out.println(new Point(4,0).distanceTo(new Point(2,2*Math.sqrt(3))));
